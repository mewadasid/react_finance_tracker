...
export default function Form() {
        ...
        switch (name) {
            case "tran_receipt":
                if (e.target.files[0].size > '100000') {
                    setFormError({ ...formerror, file_big: "Files size must be less than 1 MB" })
                }
                else {
                    setFormError(c => {
                        console.log(c);
    ...
    useEffect((e) => {
        ...
        if (transaction["tran_amount"] !== "") {
            ...
            if (transaction["tran_amount"] === 0 || transaction["tran_amount"] < 0) {
                setFormError({ ...formerror, amount_error: "Amount should be greater than 0" })
            }
            else {
                setFormError(c => {
    ...
    return (
        <div>
            <div>
                {formerror.field_empty ? <div className='formWrapper'>{formerror.field_empty}</div> : null}

                <form className="userform" encType='multipart/form-data' onSubmit={handelSubmit}>
                    <table id="main_table">
                        <tbody>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <Selectcombo name="tran_month" id="tranMonth" option={monthOpiton} onchange={handelChange} />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <Selectcombo name="tran_type" id="tranType" option={transactionType} onchange={handelChange} />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <Selectcombo name="tran_from" id="tranFrom" option={fromToAccount} onchange={handelChange} />
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <Selectcombo name="tran_to" id="tranTo" option={fromToAccount} onchange={handelChange} />
                                    <span className='fieldError'>{formerror.account_same}</span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type='number' name='tran_amount' id='tranAmount' onChange={handelChange} />
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type='file' name='tran_receipt' id='tranReceipt' onChange={handelChange} />
                                    <img src={transaction.tran_receipt} width="100" alt='content' />
                                    <span className='fieldError'>{formerror.file_big}</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <textarea name='tran_note' id='tranNote' rows="3" onChange={handelChange}></textarea>
